...
plt.scatter(Bound[:,0],Bound[:,1],s=2,color='blue',label='Bounded')
plt.scatter(Collision[:,0],Collision[:,1],s=2,color='RED',label='Collision')
plt.scatter(Escape[:,0],Escape[:,1],s=2,color='GREY',label='Escape')
