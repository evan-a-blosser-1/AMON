...
################################
# Path to Data
Dat_Path = "Databank/Smap_ae_1950DA/"
##############################################
##############################################
...
plt.scatter(Bound[:,0],Bound[:,1],color='blue',label='Bounded')
plt.scatter(Collision[:,0],Collision[:,1],color='RED',label='Collision')
plt.scatter(Escape[:,0],Escape[:,1],color='GREY',label='Escape')
